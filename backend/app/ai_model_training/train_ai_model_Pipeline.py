...
def training_lottery_model_Pipeline(
...
def training_lottery_model_Pipeline2(X_train, y_train, config):
    ...
    try:
        ...
        return metrics, feature_importance_json, X_train, top_hit_numbers, pipeline
